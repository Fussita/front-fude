...
import { presentationText } from '../../../_core/constants/presentation-text';
...
export class SectionAboutUsComponent {
  ...
  textVB = `La humildad y el amor en la labor social son fundamentales, especialmente al apoyar a niños, niñas, adolescentes y adultos mayores.`
